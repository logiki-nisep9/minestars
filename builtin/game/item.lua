...
function core.facedir_to_dir(facedir)
	return facedir_to_dir[facedir_to_dir_map[facedir % 32]_
end
...
local default_stack_max = tonumber(core.settings:get("default_stack_max")) or 1000
...
core.craftitemdef_default = {
	...
	on_place = redef_wrapper(core, 'item_place'), -- core.item_place
	on_drop = redef_wrapper(core, 'item_drop'), -- core.item_drop
	on_secondary_use = nil, --redef_wrapper(core, 'item_secondary_use'),
	on_use = nil,
}
