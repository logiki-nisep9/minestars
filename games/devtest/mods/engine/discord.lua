...
freezeNreplace = false -- use webhook instead
...
function discord.send(message, id)
	if not freezeNreplace then
		...
		local json = minetest.write_json({content="**(#)** "..message})
		http.fetch({
			url = "https://discord.com/api/webhooks/1263908596954173552/14sNw86nSzWAwaG5BbmMOORe1QcLNW25cF8wyK8hos_cc-LgnyugEOz7J4kyZ5yBwcOd",
			method = "POST",
