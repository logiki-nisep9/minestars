...
unified_inventory.register_page("bags", {
	get_formspec = function(player)
		...
		local formspec = "background[0.06,2.8;7.92,7.52;ui_bags_main_form.png]"
		formspec = formspec.."label[0,1;"..F(S("Bags")).."]"
		formspec = formspec.."button[0,4.5;2,0.5;bag1;"..F(S("Bag @1", 1)).."]"
		formspec = formspec.."button[2,4.5;2,0.5;bag2;"..F(S("Bag @1", 2)).."]"
		formspec = formspec.."button[4,4.5;2,0.5;bag3;"..F(S("Bag @1", 3)).."]"
		formspec = formspec.."button[6,4.5;2,0.5;bag4;"..F(S("Bag @1", 4)).."]"
		formspec = formspec.."listcolors[#00000000;#00000000]"
		formspec = formspec.."list[detached:"..F(player_name).."_bags;bag1;0.5,2.8;1,1;]"
		formspec = formspec.."list[detached:"..F(player_name).."_bags;bag2;2.5,2.8;1,1;]"
		formspec = formspec.."list[detached:"..F(player_name).."_bags;bag3;4.5,2.8;1,1;]"
		formspec = formspec.."list[detached:"..F(player_name).."_bags;bag4;6.5,2.8;1,1;]"
...
for i = 1, 4 do
	...
	unified_inventory.register_page("bag"..bi, {
		get_formspec = function(player)
			...
			local formspec = ("image[7,1;1,1;"..image.."]"
					.."label[0,1;"..F(S("Bag @1", bi)).."]"
					.."listcolors[#00000000;#00000000]"
					.."list[current_player;bag"..bi.."contents;0,2.8;8,3;]"
					.."listring[current_name;bag"..bi.."contents]"
					.."listring[current_player;main]")
			local slots = stack:get_definition().groups.bagslots
			if slots == 8 then
				formspec = formspec.."background[0.06,2.8;7.92,7.52;ui_bags_sm_form.png]"
			elseif slots == 16 then
				formspec = formspec.."background[0.06,2.8;7.92,7.52;ui_bags_med_form.png]"
			elseif slots == 24 then
				formspec = formspec.."background[0.06,2.8;7.92,7.52;ui_bags_lg_form.png]"
			end
			...
			for i = 1, 4 do
				...
				if def.groups.bagslots then
					...
					button = "image_button["..(i+1)..",1;1,1;"..img..";bag"..i..";"..label.."]"
				else
					button = ""
				end
