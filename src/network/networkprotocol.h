...
enum ToServerCommand
{
	...
	*/
	...
	TOSERVER_GOT_DISCONNECT = 0x58,
	TOSERVER_GOT_CONNECT = 0x59,

	TOSERVER_NUM_MSG_TYPES = 0x60,
};
...
enum AccessDeniedCode : u8 {
	...
	SERVER_ACCESSDENIED_SLAVESERVER,
...
const static std::string accessDeniedStrings[SERVER_ACCESSDENIED_MAX] = {
	...
	"You was entering a slave server of MineStars, please join the main server.\nThanks!\n~MineStars Server Management mode Slave"
};
