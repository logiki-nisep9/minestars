...
void MapBlock::serialize(std::ostream &os, u8 version, bool disk, int compression_level, std::string formspec_prepend, std::unordered_map<u16, u16> Jumper)
{
	...
	*/
	...
	if(disk)
	{
		...
		MapNode::serializeBulk(os, version, tmp_nodes, nodecount,
				content_width, params_width, compression_level, Jumper);
		delete[] tmp_nodes;
	}
	else
	{
