...
#define CUSTOM_RIDX_METATABLE_MAP       (CUSTOM_RIDX_BASE + 4)
#define CUSTOM_RIDX_READ_VECTOR         (CUSTOM_RIDX_BASE + 5)
#define CUSTOM_RIDX_PUSH_VECTOR         (CUSTOM_RIDX_BASE + 6)
#define CUSTOM_RIDX_READ_NODE           (CUSTOM_RIDX_BASE + 7)
#define CUSTOM_RIDX_PUSH_NODE           (CUSTOM_RIDX_BASE + 8)
#define CUSTOM_RIDX_PUSH_MOVERESULT1    (CUSTOM_RIDX_BASE + 9)
